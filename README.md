...
- `http://127.0.0.1:8000/attendance-app/` for the attendance operations desk

Do not open an app by double-clicking its `index.html` file. The student, parent, faculty, and attendance portals require the server above for authentication, API access, and PWA features.
