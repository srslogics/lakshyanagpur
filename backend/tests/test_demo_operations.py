...
def test_demo_login_receives_only_synthetic_workspace(client, database):
    ...
    assert login.json()["user"] == {
        ...
        "permissions": {
            ...
            "attendance": {"read": False, "create": False, "edit": False},
            "academics": {"read": False, "create": False, "edit": False},
            "examinations": {"read": False, "create": False, "edit": False},
            "timetable": {"read": False, "create": False, "edit": False},
            "communication": {"read": False, "create": False, "edit": False},
            "inventory": {"read": False, "create": False, "edit": False},
            "reports": {"read": False, "create": False, "edit": False},
        },
    }
