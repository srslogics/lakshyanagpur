const CACHE = "lakshya-student-v27";
const ASSETS = ["./", "../portal-shared.css?v=4", "./styles.css?v=13", "../auth-shared.css?v=7", "./app.js?v=17", "./manifest.webmanifest", "../lakshya-logo-576.png", "../pwa-icon-192.png"];
