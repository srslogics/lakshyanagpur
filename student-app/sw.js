const CACHE = "lakshya-student-v37";
const ASSETS = ["./", "../portal-shared.css?v=4", "./styles.css?v=16", "../auth-shared.css?v=12", "./app.js?v=24", "./manifest.webmanifest", "../lakshya-logo-576.png?v=20260804-no-tm", "../pwa-icon-192.png?v=20260804-no-tm"];
