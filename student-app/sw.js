const CACHE = "lakshya-student-v33";
const ASSETS = ["./", "../portal-shared.css?v=4", "./styles.css?v=14", "../auth-shared.css?v=9", "./app.js?v=20", "./manifest.webmanifest", "../lakshya-logo-576.png?v=20260804-no-tm", "../pwa-icon-192.png?v=20260804-no-tm"];
