const CACHE = "lakshya-student-v24";
const ASSETS = ["./", "../portal-shared.css?v=4", "./styles.css?v=12", "../auth-shared.css?v=6", "./app.js?v=14", "./manifest.webmanifest", "../lakshya-logo-576.png", "../pwa-icon-192.png"];
