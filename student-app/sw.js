const CACHE = "lakshya-student-v12";
const ASSETS = ["./", "../portal-shared.css?v=2", "./styles.css?v=6", "../auth-shared.css?v=5", "./app.js?v=5", "./manifest.webmanifest", "../lakshya-logo.png", "../pwa-icon-192.png", "../pwa-icon-512.png", "../share-card.png"];
