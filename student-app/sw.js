const CACHE = "lakshya-student-v30";
const ASSETS = ["./", "../portal-shared.css?v=4", "./styles.css?v=14", "../auth-shared.css?v=7", "./app.js?v=19", "./manifest.webmanifest", "../lakshya-logo-576.png", "../pwa-icon-192.png"];
